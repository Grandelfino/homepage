...
const AboutUS = () => {
  return (
   ...
   <Typography variant="body1" fontSize="1.2rem">
          ...
          <br />
          2007年度大会から参戦し、2012・2016・2017・2022・2023・2024・2025年度には総合優勝を果たしました。
        </Typography>
        <Card variant="outlined" sx={{ maxWidth: 600 }}>
          <CardMedia>
            <StaticImage src="../images/index/index_12.jpg" alt="Top page" />
          </CardMedia>
        </Card>
        <Button
          variant="outlined"
  ...
  return (
    <Grid align="center">
      ...
      <Typography variant="body1" fontSize="1.3rem">
          2023年度にクラウドファンディングを行い、総勢97名様からご支援を頂きました。
        </Typography>
